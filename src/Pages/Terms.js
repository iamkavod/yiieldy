          ...
          <div className="flex flex-col mb-16 sm:text-center sm:mb-0">
            <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-[1443px] md:mb-12">
              ...
              <p className="text-base text-primaryColor md:text-lg">
                These guidelines outline user behaviour, responsibilities, and acceptable conduct while interacting with our products or services.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="px-10 py-6 flex flex-col gap-3 lg:max-w-screen-[1443px]" id="terms">
        <section className="flex flex-col gap-3">
          ...
          <p className="text-[13px] text-justify">
            ...
            applications (the "Mobile App"), in each case operated by Logicgraph Ltd working as Yiieldy ("Yiieldy", "us," "we," "our"). All references to "you" or "your" herein shall refer to the end customer purchasing access to the website, Service, web app, or mobile app described herein.
          </p>
        </section>
